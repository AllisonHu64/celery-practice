from handler.docker.errors import MymathImageRunFailedException
...
def myadd(num1, num2):
    ...
    try:
        return 'Result for add(%d, %d) is %d.\n' % (num1, num2, result.get(timeout=10))
    except MymathImageRunFailedException:
        return 'Failed to run add(%d, %d) as image in docker\n' % (num1, num2)
...
def mysub(num1, num2):
    ...
    try:
        ...
        return 'Failed to run sub(%d, %d) as image in docker\n' % (num1, num2)
    except Exception as e:
...
def mymul(num1, num2):
    ...
    try:
        ...
        return 'Failed to run mul(%d, %d) as image in docker\n' % (num1, num2)
    except Exception as e:
...
def mydiv(num1, num2):
    ...
    try:
        ...
        return 'Failed to run div(%d, %d) as image in docker\n' % (num1, num2)
    except Exception as e:
